...
@Service
public class FilesStorageHelper {
    private final Path fileStorageLocation;
    private final String uploadDir;

    @Autowired
    public FilesStorageHelper(FileStorageProperties fileStorageProperties) {
    ...
    public Object storeFile(MultipartFile file) {
        ...
        try {
            ...
            return new FileDetailResponse(fileName, uploadDir, targetLocation.toString());
